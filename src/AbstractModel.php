...
abstract class AbstractModel
{
    ...
    {
        $this->db_connection->exec('SET application_name = "'.$application_name.' / 1234567890AZERTYUIOPQSDFGHJKLMWXCVBN_1234567890AZERTYUIOPQSDFGHJKLMWXCVBN' . get_called_class() . '"');
